...
def main():
    ...
    parser.add_argument(r"results.txt", type=str, help="Path to detections file.")
    parser.add_argument(r"Western-GM-Hidden-Insights-Challenge\val_labels_8_bit.txt", type=str, help="Path to ground truths file.")
