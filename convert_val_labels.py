...
labels_txt = "thermal_dataset/8_bit_dataset/8_bit_dataset/val_labels_8_bit.txt"
images_folder = "thermal_dataset/8_bit_dataset/8_bit_dataset/dataset/val/images"
output_labels_folder = "thermal_dataset/8_bit_dataset/8_bit_dataset/dataset/val/labels"
...
print("✅ Validation labels conversion complete (Class labels decremented by 1).")
